...
#ifndef LR_INTERFACES__SRV__DETAIL__HEIGHT__FUNCTIONS_H_
#define LR_INTERFACES__SRV__DETAIL__HEIGHT__FUNCTIONS_H_
...
#include "lr_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "lr_interfaces/srv/detail/height__struct.h"

/// Initialize srv/Height message.
/**
...
/// Create srv/Height message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lr_interfaces__srv__Height_Request__init().
...
/// Destroy srv/Height message.
/**
 * It calls
 * lr_interfaces__srv__Height_Request__fini()
...
/// Check for srv/Height message equality.
/**
...
/// Initialize array of srv/Height messages.
/**
...
/// Finalize array of srv/Height messages.
/**
 * It calls
 * lr_interfaces__srv__Height_Request__fini()
...
/// Create array of srv/Height messages.
/**
 * It allocates the memory for the array and calls
 * lr_interfaces__srv__Height_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Height messages.
/**
 * It calls
 * lr_interfaces__srv__Height_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Height message array equality.
/**
...
/// Copy an array of srv/Height messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lr_interfaces__srv__Height_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lr_interfaces
...
/**
 * It calls
 * lr_interfaces__srv__Height_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lr_interfaces
...
/**
 * It allocates the memory for the array and calls
 * lr_interfaces__srv__Height_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lr_interfaces
...
/**
 * It calls
 * lr_interfaces__srv__Height_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LR_INTERFACES__SRV__DETAIL__HEIGHT__FUNCTIONS_H_
